-- Relatório Atestados
SELECT CASE
  WHEN vinculo = 'Magistrado' THEN '1 - Afastamentos de Saúde - Magistrados'
  ELSE '2 - Afastamentos de Saúde - Servidores'
  END as tipo_info,
  cid_codigo,
  '' as desc,
...
GROUP BY
  faixa, cid_codigo, sexo1, grau, vinculo,
  area
ORDER BY faixa, vinculo, dias_afastamento, cid_codigo) as P;
